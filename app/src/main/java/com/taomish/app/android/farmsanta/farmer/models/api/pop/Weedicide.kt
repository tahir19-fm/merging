...
data class Weedicide(
    ...
    @SerializedName("preHarvestInterval") var preHarvestInterval: PreHarvestInterval? = null,
    ...
    @SerializedName("weedicideCategory") var weedicideCategory: String? = null,
    @SerializedName("weedicideType") var weedicideType: String? = null,
    @SerializedName("weeds") var weeds: ArrayList<String>? = null
)
