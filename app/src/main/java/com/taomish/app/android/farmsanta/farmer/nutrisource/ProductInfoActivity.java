...
public class ProductInfoActivity extends AppCompatActivity  implements NavigationView.OnNavigationItemSelectedListener{
    ...
    private String ProductName, ProductPrice, ProductImage, ProductNExpiryDate, ProductIsFavorite, IsOffered,ProductDetails;
    //xml views
    private ImageView PImage, PIsFav;
    private TextView PName, PCategory, PAmount, PPrice, OldPrice,OfferRate, PExpiryDate,suppliername,Productdetails;
    private RelativeLayout CheckCartContainer;
    private LinearLayout AddToCartContainer,DeleteFromCartContainer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ProductDetails= getIntent().getStringExtra("Product Details");
    ...
    private void onClicking(){
        PIsFav.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(ProductIsFavorite.equalsIgnoreCase("true")){
                    ...
                    DatabaseReference x= FirebaseDatabase.getInstance("https://farmsanta-partners-default-rtdb.asia-southeast1.firebasedatabase.app").getReference().child("favourites").child(UserId);
                    ...
                    DatabaseReference x= FirebaseDatabase.getInstance("https://farmsanta-partners-default-rtdb.asia-southeast1.firebasedatabase.app").getReference().child("favourites").child(UserId).child(ProductName);
                    x.child("checked").setValue(true);
                    x.child("productimage").setValue(ProductImage);
                    x.child("productprice").setValue("INR "+ProductPrice);
        ...
        Confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatabaseReference x = FirebaseDatabase.getInstance("https://farmsanta-partners-default-rtdb.asia-southeast1.firebasedatabase.app").getReference().child("cart").child(UserId);
    ...
    private void setProductData(){
        ...
        if(IsOffered.equalsIgnoreCase("yes")){
            ...
            PPrice.setText("Price: "+PriceAfterOffer+" INR");
            OldPrice. setText(ProductPrice+" INR");
            OfferRate.setText("- 30%");
            OldPrice.setPaintFlags(OldPrice.getPaintFlags() | Paint.STRIKE_THRU_TEXT_FLAG);
        }
        else{
            OfferContainer.setVisibility(View.GONE);
            PPrice.setText("Price: "+ProductPrice+" INR");
        }
        ...
        PCategory.setVisibility(View.GONE);
...
/*
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()){
                    ...
                    for(DataSnapshot dataSnapshot1 : snapshot.getChildren()){
                        ...
                        PCategory.setText(dataSnapshot1.getKey().toString());
    ...
    public void onBackPressed() {
        Intent i= new Intent(ProductInfoActivity.this, MarketPlaceHome.class);
