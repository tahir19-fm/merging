...
class GetCropByIdTask : FarmSantaBaseAsyncTask() {
    ...
    override fun doInBackground(vararg string: String?): CropMaster {
        return ServiceController(context).getCropById(string[0])
    }
}