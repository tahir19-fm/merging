...
public class SoilLabAdapter extends RecyclerView.Adapter<SoilLabAdapter.ViewHolder> {
    ...
    public SoilLabAdapter(Context context, ArrayList<Product_Data> modelList) {
    ...
    public void onBindViewHolder(ViewHolder holder, @SuppressLint("RecyclerView") final int position) {
        ...
        SingleItemSoil itemListDataAdapter = new SingleItemSoil(mContext, singleSectionItems);
        ...
        itemListDataAdapter.SetOnItemClickListener(new SingleItemSoil.OnItemClickListener() {
            @Override
