...
public class ServiceAdapter extends RecyclerView.Adapter<ServiceAdapter.ViewHolder> {
    ...
    public ServiceAdapter(Context context, ArrayList<Service_Data> modelList) {
    ...
    public void onBindViewHolder(ViewHolder holder, @SuppressLint("RecyclerView") final int position) {
        ...
        SingleItemServices itemListDataAdapter = new SingleItemServices(mContext, singleSectionItems);
        ...
        itemListDataAdapter.SetOnItemClickListener(new SingleItemServices.OnItemClickListener() {
            @Override
