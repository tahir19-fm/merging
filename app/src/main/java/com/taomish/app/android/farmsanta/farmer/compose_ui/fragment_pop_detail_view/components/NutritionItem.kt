    ...
    Column(
        ...
        cropNutrition.dosages?.forEachIndexed { index, dosage ->
            ...
            IPMFieldRow(
                ...
                value = "${dosage.nitrogen.ifNull { 0.0 }} kg/ha"
            )
            IPMFieldRow(
                metaData = str(id = R.string.phosphorus),
                value = "${dosage.phosphorus.ifNull { 0.0 }} kg/ha"
            )

            IPMFieldRow(
                metaData = str(id = R.string.potassium),
                value = "${dosage.potassium.ifNull { 0.0 }} kg/ha"
            )

            IPMFieldRow(
                metaData = str(id = R.string.zinc),
                value = "${dosage.zinc.ifNull { 0.0 }} kg/ha"
            )

            IPMFieldRow(
                metaData = str(id = R.string.sulphur),
                value = "${dosage.sulphur.ifNull { 0.0 }} kg/ha"
            )
