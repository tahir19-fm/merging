...
class GetSearchedFarmScoutingTask(private val searchText: String) : FarmSantaBaseAsyncTask() {
    ...
    override fun doInBackground(vararg string: String?): Array<out FarmScouting> {
        return ServiceController(context).getSearchedScouting(searchText)
    }
}