...
class GetLandUnitsMeasurements : FarmSantaBaseAsyncTask() {
    ...
    override fun doInBackground(vararg string: String?): ArrayList<UOMType> {
        return ServiceController(context).landUnitsOfMeasurements
    }
}