...
import com.taomish.app.android.farmsanta.farmer.compose_ui.fragment_ipm_weed_management.IPMWeedManagementFragmentScreen
...
class IPMWeedManagementFragment : FarmSantaBaseFragment() {
    ...
    override fun onCreateView(
        ...
        binding.homeComposeView.apply {
            ...
            setContent {
                MyApp {
                    IPMWeedManagementFragmentScreen(
                        viewModel = viewModel,
                        onZoomImage = this@IPMWeedManagementFragment::goToZoomImage
                    )
                }
            }
        }
    ...
    private fun goToZoomImage(imageUrl: String) {
        fragmentChangeHelper?.onFragmentData(
            AppConstants.FragmentConstants.ZOOM_IMAGE_FRAGMENT_FROM_IPM_WEEDS, imageUrl
        )
    }
