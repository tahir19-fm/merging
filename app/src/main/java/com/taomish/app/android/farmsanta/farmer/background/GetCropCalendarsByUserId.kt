...
class GetCropCalendarsByUserId : FarmSantaBaseAsyncTask() {
    ...
    override fun doInBackground(vararg string: String?): ArrayList<CropCalendar> {
        return ServiceController(context).cropCalendarsById
    }
}