...
public class CustomThreadPoolManager {
    ...
    private CustomThreadPoolManager() {
        ...
        Log.e(ThreadUtil.TAG,"Available cores: " + NUMBER_OF_CORES);
    ...
    public void cancelAllTasks() {
        ...
        sendMessageToUiThread(ThreadUtil.createMessage(ThreadUtil.MESSAGE_ID, "All tasks in the thread pool are cancelled"));
    }
        ...
        public Thread newThread(Runnable runnable) {
            ...
            thread.setUncaughtExceptionHandler(new Thread.UncaughtExceptionHandler() {
                ...
                public void uncaughtException(Thread thread, Throwable ex) {
                    Log.e(ThreadUtil.TAG, thread.getName() + " encountered an error: " + ex.getMessage());
                }
            });
            return thread;
        }
