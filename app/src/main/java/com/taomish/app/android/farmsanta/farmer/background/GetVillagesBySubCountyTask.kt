...
class GetVillagesBySubCountyTask : FarmSantaBaseAsyncTask() {
    ...
    override fun doInBackground(vararg string: String?): Array<out Village> {
        return ServiceController(context).getVillagesBySubCounty(string[0])
    }
}