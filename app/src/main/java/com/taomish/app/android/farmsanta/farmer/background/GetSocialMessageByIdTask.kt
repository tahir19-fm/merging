...
class GetSocialMessageByIdTask : FarmSantaBaseAsyncTask() {
    ...
    override fun doInBackground(vararg string: String?): Message? {
        return ServiceController(context).getMessageById(string[0], string[1])
    }
}