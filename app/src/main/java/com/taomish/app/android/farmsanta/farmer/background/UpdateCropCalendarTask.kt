...
class UpdateCropCalendarTask(private val cropCalendar: CropCalendar) : FarmSantaBaseAsyncTask() {
    ...
    override fun doInBackground(vararg string: String?): Any? {
        return ServiceController(context).updateCropCalendar(cropCalendar)
    }
}