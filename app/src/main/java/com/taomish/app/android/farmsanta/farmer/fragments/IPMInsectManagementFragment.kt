...
import com.taomish.app.android.farmsanta.farmer.compose_ui.fragment_ipm_insect_management.IPMInsectManagementFragmentScreen
...
class IPMInsectManagementFragment : FarmSantaBaseFragment() {
    ...
    override fun onCreateView(
        ...
        binding.homeComposeView.apply {
            ...
            setContent {
                MyApp {
                    IPMInsectManagementFragmentScreen(
                        viewModel = viewModel,
                        onZoomImage = this@IPMInsectManagementFragment::goToZoomImage
                    )
                }
            }
        }
    ...
    private fun goToZoomImage(imageUrl: String) {
        fragmentChangeHelper?.onFragmentData(
            AppConstants.FragmentConstants.ZOOM_IMAGE_FRAGMENT_FROM_IPM_INSECTS, imageUrl
        )
    }
}