...
class GetFertilizerFruitCropDetails: FarmSantaBaseAsyncTask() {
    ...
    override fun doInBackground(vararg string: String?): List<FertilizerFruitDetails>? {
        return ServiceController(context).fertilizerFruitDetails?.toMutableList()
    }
}