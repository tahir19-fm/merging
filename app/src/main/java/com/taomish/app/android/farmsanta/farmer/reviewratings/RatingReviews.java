package com.taomish.app.android.farmsanta.farmer.reviewratings;

import static com.taomish.app.android.farmsanta.farmer.reviewratings.Utils.getRoundedBarDrawable;
import static com.taomish.app.android.farmsanta.farmer.reviewratings.Utils.getRoundedBarGradientDrawable;
    ...
    private void draw(int dimension, Bar initialBar, final Bar bar, final View view) {
        ...
        view.post(new Runnable() {
            ...
            public void run() {
              ...
              //  setMargins(view.findViewById(R.id.linear_bar),5,10,5,10);
        ...
        if (isShowRaters) {
            ...
            if (bar.getStarLabel() != null) {
                raters.setText("("+String.format(Locale.getDefault(), "%s", bar.getUsers())+")");
            }
        }
