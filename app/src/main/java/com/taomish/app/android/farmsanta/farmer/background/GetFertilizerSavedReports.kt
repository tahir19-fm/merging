...
class GetFertilizerSavedReports: FarmSantaBaseAsyncTask() {
    ...
    override fun doInBackground(vararg string: String?): List<FertilizerGeneratedReport>? {
        return ServiceController(context).savedFertilizerReports?.toMutableList()
    }
}