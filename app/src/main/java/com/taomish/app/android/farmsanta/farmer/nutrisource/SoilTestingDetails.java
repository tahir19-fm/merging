...
public class SoilTestingDetails extends AppCompatActivity implements OnMapReadyCallback, ValueChangedListener, LimitExceededListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_soil_testing_details);
...
// finally change the color
        ...
        addtocart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i= new Intent(SoilTestingDetails.this, SoilCartActivity.class);
                i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                startActivity(i);
                Animatoo.animateSlideLeft(SoilTestingDetails.this);
            }
        });
        ...
        int url1 = R.drawable.soiltestingtumblr;
        int url2 = R.drawable.soiltestingtumblr;
        int url3 = R.drawable.soiltestingtumblr;
    ...
    private void setReviewList(){
        ...
        reviewAdapter = new ReviewAdapter(SoilTestingDetails.this, ReviewList);
    ...
    public void onBackPressed() {
        Intent i= new Intent(SoilTestingDetails.this, SoilLabDetails.class);
        i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
        startActivity(i);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if (ActivityCompat.checkSelfPermission(SoilTestingDetails.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(SoilTestingDetails.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
