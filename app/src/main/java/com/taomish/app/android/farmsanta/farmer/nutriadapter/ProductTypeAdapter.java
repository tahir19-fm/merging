...
public class ProductTypeAdapter extends RecyclerView.Adapter<ProductTypeAdapter.ViewHolder> {
    ...
    private ArrayList<Service_Data> modelList;

    private OnItemClickListener mItemClickListener;
    private OnMoreClickListener mMoreClickListener;

    public ProductTypeAdapter(Context context, ArrayList<Service_Data> modelList) {
        this.mContext = context;
        this.modelList = modelList;
    }

    public void updateList(ArrayList<Service_Data> modelList) {
        this.modelList = modelList;
    ...
    public void onBindViewHolder(ViewHolder holder, @SuppressLint("RecyclerView") final int position) {
        ...
        final Service_Data model = getItem(position);


        ArrayList<Service_Data> singleSectionItems = model.getSingleItemArrayList();

        holder.itemTxtTitle.setText(model.getTitle());
        SingleItemProductType itemListDataAdapter = new SingleItemProductType(mContext, singleSectionItems);
        ...
        itemListDataAdapter.SetOnItemClickListener(new SingleItemProductType.OnItemClickListener() {
            @Override
    ...
    private Service_Data getItem(int position) {
    ...
    public interface OnItemClickListener {
        void onItemClick(View view, int absolutePosition, int relativePosition, Service_Data model);
    }


    public interface OnMoreClickListener {
        void onMoreClick(View view, int position, Service_Data model);
    }
