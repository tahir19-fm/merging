...
public class SoilCartAdapter extends RecyclerView.Adapter<SoilCartAdapter.SingleItemRowHolder> implements ValueChangedListener, LimitExceededListener {

    private ArrayList<Soil_Cart_Data> itemsList;
    private Context mContext;
    private OnItemClickListener mItemClickListener;

    public SoilCartAdapter(Context context, ArrayList<Soil_Cart_Data> itemsList) {
