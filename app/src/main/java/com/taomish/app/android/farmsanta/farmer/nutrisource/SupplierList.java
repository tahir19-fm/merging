...
public class SupplierList extends AppCompatActivity implements Spinner.OnItemSelectedListener,NavigationView.OnNavigationItemSelectedListener,SuppilerAdapter.RecyclerViewClickListener {
       ...
       // Toast.makeText(this, CategoryName, Toast.LENGTH_SHORT).show();
        ...
        backbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i= new Intent(SupplierList.this, MarketPlaceHome.class);
                i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                startActivity(i);
                Animatoo.animateSlideLeft(SupplierList.this);
            }
        });
        addListenerOnButton();
        setProductType();
        ...
        OrderTypeGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener()
        {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                if(checkedId==R.id.pickup) {
                    pickup.setTextColor(getResources().getColor(R.color.green_light));
                    pickup.setButtonTintList(ColorStateList.valueOf(getResources().getColor(R.color.green_light)));
                    delivery.setTextColor(getResources().getColor(R.color.white));
                    delivery.setButtonTintList(ColorStateList.valueOf(getResources().getColor(R.color.white)));
                }
                else{
                    pickup.setTextColor(getResources().getColor(R.color.white));
                    pickup.setButtonTintList(ColorStateList.valueOf(getResources().getColor(R.color.white)));
                    delivery.setTextColor(getResources().getColor(R.color.green_light));
                    delivery.setButtonTintList(ColorStateList.valueOf(getResources().getColor(R.color.green_light)));
                }
            }
        });
    ...
    private final BottomNavigationView.OnNavigationItemSelectedListener navListener = item -> {
        ...
        if (itemId == R.id.nmarketplace_order) {
            Intent i= new Intent(SupplierList.this, OrderActivity.class);
            i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
            startActivity(i);
    ...
    private void setShopList(){
       // ShopList.clear();
        ...
        ShopList.add(new Shop_Data("Farm Store",R.drawable.shopimg1,"4.5","Village Market Road","1","45","Fertilizers | Manure | Farming Tools..."));
        ShopList.add(new Shop_Data("Farm Store",R.drawable.shopimg2,"4.5","Village Market Road","1","35","Fertilizers | Manure | Farming Tools..."));
        ShopList.add(new Shop_Data("Farm Store",R.drawable.shopimg3,"4.5","Village Market Road","1","41","Fertilizers | Manure | Farming Tools..."));
        ShopList.add(new Shop_Data("Farm Store",R.drawable.shopimg4,"4.5","Village Market Road","0","55","Fertilizers | Manure | Farming Tools..."));
        ShopList.add(new Shop_Data("Farm Store",R.drawable.shopimg5,"4.5","Village Market Road","0","48","Fertilizers | Manure | Farming Tools..."));
        ShopList.add(new Shop_Data("Farm Store",R.drawable.shopimg1,"4.5","Village Market Road","0","33","Fertilizers | Manure | Farming Tools..."));
        ShopList.add(new Shop_Data("Farm Store",R.drawable.shopimg2,"4.5","Village Market Road","0","44","Fertilizers | Manure | Farming Tools..."));
        shopAdapter = new ShopAdapter(SupplierList.this, ShopList);
        ...
        shopAdapter.SetOnItemClickListener(new ShopAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(View view, int itemPosition, Shop_Data model) {
                    Intent intent= new Intent(SupplierList.this, StoreDetails.class);
    ...
    private void setSeller(){
        ...
        productAdapter = new ProductAdapter(SupplierList.this, productList);
        starseller.setHasFixedSize(true);
        LinearLayoutManager layoutManager = new LinearLayoutManager(this);
        layoutManager.setAutoMeasureEnabled(false);
        starseller.setLayoutManager(layoutManager);
        starseller.setAdapter(productAdapter);
        ...
        productAdapter.SetOnMoreClickListener(new ProductAdapter.OnMoreClickListener() {
            ...
            public void onMoreClick(View view, int position, Product_Data model) {
                Toast.makeText(SupplierList.this, "See more " + position, Toast.LENGTH_SHORT).show();
...
*/
    ...
    private void setFliter() {
        ...
        filterAdapter = new FilterAdapter(SupplierList.this, singleItemList);
        ...
        filterAdapter.SetOnItemClickListener(new FilterAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int itemPosition, FilterData model) {
                Toast.makeText(SupplierList.this, model.getTitle(), Toast.LENGTH_SHORT).show();
            }
        });
        /**************Onclick On Top Doctor************************/
    ...
    private void setNeareststore() {
        ...
        //   singleItemList.add(new Service_Data("Seeds & Seedlings",R.drawable.seedbag));
        singleItemList.add(new Store_Data("Farmer Store", R.drawable.farmstoreimg,"4.5","12K"));
        singleItemList.add(new Store_Data("Farmer Store", R.drawable.farmstoreimg,"4.5","12K"));
        singleItemList.add(new Store_Data("Farmer Store",R.drawable.farmstoreimg,"4.5","12K"));
        singleItemList.add(new Store_Data("Farmer Store",R.drawable.farmstoreimg,"4.5","12K"));
        singleItemList.add(new Store_Data("Farmer Store",R.drawable.farmstoreimg,"4.5","12K"));
        farmerStoreAdapter = new FarmerStoreAdapter(SupplierList.this, singleItemList);
    ...
    private void setOffers() {
        ...
        //   singleItemList.add(new Service_Data("Seeds & Seedlings",R.drawable.seedbag));
        singleItemList.add(new Service_Data("Shop Now", R.drawable.offerimage));
        singleItemList.add(new Service_Data("Shop Now", R.drawable.offerimage));
        singleItemList.add(new Service_Data("Shop Now",R.drawable.offerimage));
        singleItemList.add(new Service_Data("Shop Now",R.drawable.offerimage));
        singleItemList.add(new Service_Data("Shop Now",R.drawable.offerimage));
        offerlistdata.add(new Service_Data("Shop Now", singleItemList));
        offerItemServices = new OfferItemServices(SupplierList.this, singleItemList);
    ...
    private void setProductType() {
        ...
        productTypeAdapter = new ProductTypeAdapter(SupplierList.this, producttypeList);
        ...
        productTypeAdapter.SetOnItemClickListener(new ProductTypeAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int absolutePosition, int relativePosition, Service_Data model) {
               // Toast.makeText(SupplierList.this, model.getTitle(), Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(SupplierList.this,ProductByStore.class);
...
*/
    ...
    public void onClick(View view, int position) {
        ...
        Intent intent = new Intent(SupplierList.this,ProductList.class);
    ...
    private void setCategoryData(){
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(SupplierList.this));
    ...
    */
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
      ...
      /*  if(id==R.id.Home){
            startActivity(new Intent(SupplierList.this,MainActivity.class));
        }
        else if(id==R.id.Profile){
            startActivity(new Intent(SupplierList.this,UserProfileActivity.class));
        }
        else if(id == R.id.Cart){
            startActivity(new Intent(SupplierList.this, CartActivity.class));
        }
        else if(id == R.id.MyOrders){
            startActivity(new Intent(SupplierList.this, OrderActivity.class));
        }
        else if(id == R.id.favourites){
            startActivity(new Intent(SupplierList.this, favourites_activity.class));
        }
    ...
    private void CheckLogout(){
        AlertDialog.Builder checkAlert = new AlertDialog.Builder(SupplierList.this);
        checkAlert.setMessage("Do you want to Logout?")
                .setCancelable(false).setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                       /* FirebaseAuth.getInstance().signOut();
                        Intent intent=new Intent(SupplierList.this,loginActivity.class);
                        startActivity(intent);
                        finish();*/
                    }
