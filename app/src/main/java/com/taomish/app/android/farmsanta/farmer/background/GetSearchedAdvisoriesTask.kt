...
class GetSearchedAdvisoriesTask : FarmSantaBaseAsyncTask() {
    ...
    override fun doInBackground(vararg string: String?): ArrayList<CropAdvisory>? {
        return ServiceController(context).getSearchedAdvisories(string[0])
    }
}