...
public final class URLConstants {
    ...
    public static String CROP_CALENDAR_UPDATE = BASE_URL + BASE_MASTER_SERVICE + CROP_CALENDAR_INDENTIFIER;
    public static String CROP_CALENDAR_DELETE = BASE_URL + BASE_MASTER_SERVICE + CROP_CALENDAR_INDENTIFIER;
    ...
    public static final String MESSAGE = BASE_URL + BASE_MESSAGE_SERVICE + "message";
    ...
    @NonNull
    @Contract(pure = true)
    public static String getFarmScoutDetailShareURL(String id){
        return "Hey there, Checkout this FarmScout Detail\n" +
                URLConstants.FARM_SCOUTING_BY_FARMER + id + "\n\n" +
                "If you don't have Farmsanta App you can download it from PlayStore\n" +
                "https://play.google.com/store/apps/details?id=com.farmsanta.farmer";
    }
    ...
    @NonNull
    @Contract(pure = true)
    public static String getSharePostShareURL(String id){
        return "Hey there, Checkout this Shared Post Detail\n" +
                URLConstants.SOCIAL_POST + id + "\n\n" +
                "If you don't have Farmsanta App you can download it from PlayStore\n" +
                "https://play.google.com/store/apps/details?id=com.farmsanta.farmer";
    }
