...
class FarmScoutImageDetailsFragment : FarmSantaBaseFragment() {
            ...
            setContent {
                MyApp {
                    FarmScoutDetailsFragmentScreen(viewModel = viewModel,
                        onShare = this@FarmScoutImageDetailsFragment::onShare
                    )
                }
            }
        }
    ...
    private fun onShare() {
        val selectedScouting = viewModel.selectedScouting.value
        val url = URLConstants.getFarmScoutDetailShareURL(selectedScouting?.uuid ?: "")
