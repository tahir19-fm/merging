...
fun DiseasesFragmentScreen(homeViewModel: HomeViewModel, goToDiseaseDetails: () -> Unit) {
    ...
    val diseases = if (homeViewModel.selectedDiseaseCrop == null)
        ...
        homeViewModel.diseases.filter {
            it.crops?.contains(homeViewModel.selectedDiseaseCrop?.uuid) ?: false
        }
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        LazyRow(
            ...
            items(homeViewModel.crops) { crop ->
                SelectableChip(
                    text = crop.cropName,
                    isSelected = homeViewModel.selectedDiseaseCrop?.cropName == crop.cropName,
        ...
        if (diseases.isNotEmpty()) {
            LazyVerticalGrid(
                ...
                items(diseases.orEmpty()) { disease ->
//                    DiseaseItem(
