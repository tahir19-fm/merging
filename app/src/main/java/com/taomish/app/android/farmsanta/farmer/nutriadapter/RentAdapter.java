...
public class RentAdapter extends RecyclerView.Adapter<RentAdapter.ViewHolder> {
    ...
    public RentAdapter(Context context, ArrayList<Rent_Data> modelList) {
        this.mContext = context;
        this.modelList = modelList;
    }

    public void updateList(ArrayList<Rent_Data> modelList) {
        this.modelList = modelList;
    ...
    public void onBindViewHolder(ViewHolder holder, @SuppressLint("RecyclerView") final int position) {
        ...
        final Rent_Data model = getItem(position);


        ArrayList<Rent_Data> singleSectionItems = model.getSingleItemArrayList();

        holder.itemTxtTitle.setText(model.getTitle());
        RentItemServices itemListDataAdapter = new RentItemServices(mContext, singleSectionItems);
        ...
        itemListDataAdapter.SetOnItemClickListener(new RentItemServices.OnItemClickListener() {
            @Override
            public void onItemClick(View view, int itemPosition, Rent_Data model) {
    ...
    private Rent_Data getItem(int position) {
    ...
    public interface OnItemClickListener {
        void onItemClick(View view, int absolutePosition, int relativePosition, Rent_Data model);
    }


    public interface OnMoreClickListener {
        void onMoreClick(View view, int position, Rent_Data model);
    }
