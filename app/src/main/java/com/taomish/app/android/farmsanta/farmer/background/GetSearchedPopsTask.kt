...
class GetSearchedPopsTask : FarmSantaBaseAsyncTask() {
    ...
    override fun doInBackground(vararg string: String?): ArrayList<PopDto> {
        return ServiceController(context).getSearchedPops(string[0])
    }
}